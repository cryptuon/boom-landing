...
export default function SmallTicket({number}) {
    return (
        <div className='pl-3'>
            <div className="flex bg-[url('/SmallTicketOutlineBlack.svg')] bg-no-repeat bg-contain bg-center w-[10.5vw] h-[12.5vw]">
                <div className="bg-[url('/SmallTicketOutline.svg')] bg-no-repeat bg-contain bg-center w-[10.5vw] h-[12.5vw] animate-wiggleOut hover:animate-wiggle ">
                    <div className="flex flex-col justify-center h-full px-[1vw]">
                        <div className="flex items-center justify-center h-[5vw]">
                        ...
                        <div className='flex flex-1 justify-evenly flex-col'>
                            ...
                            <div className='flex flex-row justify-between items-center '>
                                ...
                                <div className='flex border-2 h-[0.5vw] w-[2.5vw] border-black rounded-2xl items-center justify-end'>
                                    <div className='bg-red-600 h-[0.25vw] w-[1.1vw] rounded-2xl'></div>
                                </div>
                            </div>
                        </div>
                    </div>
